...
plt.subplot(4, 1, 3)
plt.step(t, quantized_signal, label="PCM Modulated Signal")
...
plt.subplot(4, 1, 4)
plt.plot(t, quantized_signal, label="PCM Demodulation Signal", linestyle='--')
...
plt.grid()
plt.subplot(3, 1, 3)
plt.plot(t, filtered_signal[:-1], label='Demodulated & Filtered Signal', linestyle='dotted')
plt.legend()
plt.grid()
plt.tight_layout()
plt.show()
...
<img width="1536" height="850" alt="exp3a_1" src="https://github.com/user-attachments/assets/44850bc7-5cc7-4659-b2f6-214d3e98634c" />

<img width="1536" height="850" alt="exp3b" src="https://github.com/user-attachments/assets/b2e33d15-40b9-47c3-b039-fe34d7c22e03" />
